    ...
    class MainProgram {
        static void Main(string[] args) {
            ...
            using (StreamWriter writer = new StreamWriter(path, false)) {
                ...
                writer.WriteLine("This files simply logs the output.");
                writer.WriteLine("This will be generated automatically by the calculator.\n");
                writer.WriteLine("Staring output...\n");
            }
            ...
            tsw.WriteLine($"{SINGLE_TAB}\"Niji's Calculator\"");
            Console.WriteLine($"{DOUBLE_TAB}By Niji System");
            tsw.WriteLine($"{DOUBLE_TAB}By Niji System");
            Console.WriteLine(BLANK_LINE);
            tsw.WriteLine("\n");
            Console.WriteLine("This is a calculator written in C#.");
            tsw.WriteLine("This is a calculator written in C#.");

            // The main calculator part :3
            do {
                // Math variables
                long x = 0;
                tsw.WriteLine($"Variable `x' has been set to {x}");
                long y = 0;
                tsw.WriteLine($"Variable `y' has been set to {y}");
                double yDivide = 0.000000000000000;
                tsw.WriteLine($"Variable `yDivide' has been set to {yDivide}");

                // This controls whether or not the DividedByZero code runs.
                bool divideByZero = false;
                tsw.WriteLine($"Variable `divideByZero' has been set to {divideByZero}");
                Console.WriteLine("What operation would you like to perform?");
                tsw.WriteLine("What operation would you like to perform?");
                Console.WriteLine("Your current options are:");
                tsw.WriteLine("Your current options are:");
                ...
                tsw.WriteLine($"{operations[0, 0]}{SINGLE_TAB}{operations[0, 1]}{SINGLE_TAB}{operations[0, 2]}{LINE_BREAK}{operations[0, 3]}{SINGLE_TAB}{operations[0, 4]}{DOUBLE_TAB}{operations[0, 5]}{LINE_BREAK}{operations[0, 6]}{DOUBLE_TAB}{operations[0, 7]}{DOUBLE_TAB}Exit");

                // Retrieve user input
                Console.WriteLine("Please enter your selection: ");
                operation = Console.ReadLine();
                tsw.WriteLine($"Please enter your selection: {operation}");
